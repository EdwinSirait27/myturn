...
class LoginController extends Controller
{
    ...
    //             // Specific MAC address check for Ethernet adapter
    //             $ethernetMac = $this->getSpecificEthernetMac();
    //             if ($ethernetMac) {
    //                 $macAddresses[] = $ethernetMac; // Add the specific MAC to the list
    //                 Log::info("Added specific Ethernet MAC: {$ethernetMac}");
    //             }
    ...
    // /**
    //  * Get specific Ethernet adapter MAC address
    //  */
    // private function getSpecificEthernetMac()
    // {
    //     if (PHP_OS_FAMILY === 'Windows') {
    //         $output = [];
    //         exec('ipconfig /all', $output);
            
    //         $isEthernetAdapter = false;
    //         foreach ($output as $line) {
    //             // Check if this is the Ethernet adapter we're looking for
    //             if (strpos($line, 'Ethernet adapter Ethernet:') !== false) {
    //                 $isEthernetAdapter = true;
    //                 continue;
    //             }
    ...
    //                 // If we reach another adapter section, stop looking
    //                 if (strpos($line, 'adapter') !== false && $line !== 'Ethernet adapter Ethernet:') {
    //                     $isEthernetAdapter = false;
    //                 }
    //             }
    //         }
