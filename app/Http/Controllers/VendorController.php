    ...
    public function getVendors($hashedId)
{
   ...
   $vendors = $vendorgroup->vendors()->with('banks','country','group','store')->select(['id', 'type','code','address','name','city','country_id','email','phonenumber','consignment','vendorpkp','salesname','salescp','npwpname','npwpnumber','npwpaddress','bank_id','description']); // pilih kolom eksplisit
