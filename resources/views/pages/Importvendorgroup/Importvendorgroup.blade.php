@extends('layouts.app')
@section('title', 'Import Vendor Group')
@push('styles')
...
@section('main')<div class="main-content">
    ...
    <div class="form-container">
        <h2>Import Vendor Group</h2>
        <form id="import-create" action="{{ route('Importvendorgroup.vendorgroup') }}" method="POST" enctype="multipart/form-data">
            @csrf
