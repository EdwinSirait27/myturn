                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6><i class="fas fa-user-shield"></i> List Vendors</h6>
                            </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover" id="users-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Type LOC</th>
                                                <th class="text-center">Type Liabilities</th>
                                                <th class="text-center">Vendor PKP</th>
                                                <th class="text-center">Transaction Type</th>
                                                <th class="text-center">Direct Incoming</th>
                                                <th class="text-center">TOP</th>
                                                <th class="text-center">NPWP Namw</th>
                                ...
                                <div class="action-buttons">
                                    <button type="button" onclick="window.location='{{ route('Vendor.create') }}'"
                                        ...
                                        <i class="fas fa-plus-circle"></i> Create Vemdor
                                    </button>
                                </div>
