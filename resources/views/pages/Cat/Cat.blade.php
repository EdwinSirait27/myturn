                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6><i class="fas fa-user-shield"></i> List Categories</h6>
                            </div>
                            ...
                            <div class="card-body">
                                    ...
                                    <table class="table table-hover" id="users-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Departmemnts Name</th>
                                ...
                                <div class="action-buttons">
                                    <button type="button" onclick="window.location='{{ route('Cat.create') }}'"
