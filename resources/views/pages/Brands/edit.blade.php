    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Update Brands {{ $brand->brand_name }}</h1>
                <div class="section-header-breadcrumb">
                    {{-- <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div> --}}
                    <div class="breadcrumb-item"><a href="{{ route('pages.Brands') }}">Brands</a></div>
                    <div class="breadcrumb-item">Update Brands {{ $brand->brand_name }}</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Update Brands') }} {{ $brand->brand_name }}</h6>
                                </div>
