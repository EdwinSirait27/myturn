        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('pages.Brands') }}">Positions</a></div>
                    <div class="breadcrumb-item">Create Brands</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Brands') }}</h6>
                                </div>
                                    ...
                                    <form id="brands-create" action="{{ route('Brands.store') }}" method="POST">
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a brand code and brand name is already registered, you cannot register it
                                                <br>
                                            </span>
                                        </div>
