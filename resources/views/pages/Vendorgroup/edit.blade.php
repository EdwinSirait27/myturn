@extends('layouts.app')
@section('title', 'Update Vendor Groups')
@push('style')
    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Update Vendor Groups {{ $vendorgroup->name }}</h1>
                <div class="section-header-breadcrumb">
                    {{-- <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div> --}}
                    <div class="breadcrumb-item"><a href="{{ route('pages.Vendorgroup') }}">Vendor Group</a></div>
                    <div class="breadcrumb-item">Update Vendor Group {{ $vendorgroup->name }}</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Update Vendor Group') }} {{ $vendorgroup->name }}</h6>
                                </div>
                                <div class="card-body pt-4 p-3">
                                    ...
                                    <form id="roles-edit" action="{{ route('Vendorgroup.update', $hashedId) }}" method="POST">
                                        @csrf
                                        @method('PUT')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input type="text"
                                                            ...
                                                            id="name" name="name"
                                                            value="{{ old('name', $vendorgroup->name) }}"
                                                            placeholder="Insert Vendor Group Name" required>
                                                        @error('name')
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <input
                                                            ...
                                                            value="{{ old('description', $vendorgroup->description ?? '') }}"
                                                            type="text" id="description" name="description"
                                                            value="{{ old('description') }}" aria-describedby="info-description"
                                                            maxlength="150" placeholder="Insert description if you want">
                                                        @error('description')
                                                            <span class="invalid-feedback" role="alert">
                                                                <strong>{{ $message }}</strong>
                                                            </span>
