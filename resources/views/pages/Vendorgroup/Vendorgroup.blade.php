                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6><i class="fas fa-user-shield"></i>List Vendor Groups</h6>
                            </div>
                                    ...
                                    <table class="table table-hover" id="users-table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center">Vendor Group Code </th>
    ...
    $('#logTable').DataTable({
        ...
        columns: [
            ...
            { data: 'description', name: 'description', className: 'text-center' },
             { data: 'user', name: 'causer_id', className: 'text-center' },
            { data: 'detail', name: 'properties', className: 'text-center', orderable: false, searchable: false },
        ]
    });
});
</script>
    <script>
        ...
        jQuery(document).ready(function($) {
            ...
            var table = $('#users-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '{{ route('vendorgroups.vendorgroups') }}',
                    type: 'GET'
                },
                responsive: true,
                lengthMenu: [
