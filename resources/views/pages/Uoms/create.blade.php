        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item"><a href="{{ route('pages.Uoms') }}">Positions</a></div>
                    <div class="breadcrumb-item">Create Unit of Measure</div>
                </div>
            </div>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Create Unit of Measure') }}</h6>
                                </div>
                                    ...
                                    <form id="uom-create" action="{{ route('Uoms.store') }}" method="POST">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        ...
                                                        @enderror
                                        <p class="text-muted text-xs mt-2">Example: PCS
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                ...
                                                - If a uom code and uom  is already registered, you cannot register it again.<br>
                                            </span>
                                        </div>
