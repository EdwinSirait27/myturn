                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header pb-0 px-3">
                                    <h6 class="mb-0">{{ __('Update Uoms') }} {{ $uom->uom }}</h6>
                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div>
                                                        <select name="uom" class="form-control @error('uom') is-invalid @enderror"required>
                                                            ...
                                                            <option value="{{ $value }}"
                                                            {{ old('uom', $uom->uom ?? '') == $value ? 'selected' : '' }}>
                                                            {{ $value }}
                                                        </option>
