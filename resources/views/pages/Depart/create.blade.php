...
@section('main')
    <div class="main-content">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body pt-4 p-3">
                                    ...
                                    <form id="roles-create" action="{{ route('Depart.store') }}" method="POST">
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-6">
       ...
       style="text-transform: uppercase;">
                                                        ...
                                                        @enderror
                                        <p class="text-muted text-xs mt-2">Example: Food probably
                                        ...
                                        <div class="alert alert-secondary mt-4" role="alert">
                                            <span class="text-dark">
                                                <strong>Important Note:</strong> <br>
                                                                                              - If Departments already exist, you cant input the same Departments again, for exm: Food already registered then you can't input the same data okay.<br>
