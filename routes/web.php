...
Route::middleware(['auth', 'role:Admin|HeadHR|HR|Buyer|HeadBuyer'])->group(function () {
    Route::get('/feature-profile', function () {
        return view('pages.feature-profile', ['type_menu' => 'features']);
    });
    Route::group(['middleware' => ['permission:dashboardHeadBuyer']], function () {

        Route::get('/dashboardHeadbuyer', [DashboardHeadbuyer::class, 'index'])
            ->name('pages.dashboardHeadbuyer');
    });
    Route::group(['middleware' => ['permission:dashboardBuyer']], function () {
    ...
    Route::group(['middleware' => ['permission:ManageVendorgroups']], function () {
